...
import 'package:hizli_randevu_sistemi/pages/ogretim_elemani_sifre_yenileme_sayfasi.dart';
import 'package:hizli_randevu_sistemi/pages/sifre_yenileme_sayfasi.dart';

class OgrMailDogrulamaSayfasi extends StatefulWidget {
  @override
  _OgrMailDogrulamaSayfasiState createState() => _OgrMailDogrulamaSayfasiState();
}

class _OgrMailDogrulamaSayfasiState extends State<OgrMailDogrulamaSayfasi> {
                        ...
                        Container(
                          ...
                          child: MaterialButton(
                            ...
                            onPressed: ()async {
                              ...
                              var rsp = await aps.mailOgrDogrula(token);
                              print(rsp);
                              if(rsp['token'] == token){
                                Util.token = token;
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>OgretimElemaniSifreYenilemeFormu()));
