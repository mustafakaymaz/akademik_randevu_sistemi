...
import 'package:hizli_randevu_sistemi/pages/ogretim_elemani_mail_sifre_dogrulama.dart';
import 'package:rflutter_alert/rflutter_alert.dart';



class OgretimElemaniSifremiUnuttumSayfasi extends StatefulWidget {

  @override
  _OgretimElemaniSifremiUnuttumSayfasiState createState() => _OgretimElemaniSifremiUnuttumSayfasiState();
}

class _OgretimElemaniSifremiUnuttumSayfasiState extends State<OgretimElemaniSifremiUnuttumSayfasi> {
                        ...
                        Container(
                          ...
                          child: MaterialButton(
                            ...
                            onPressed: () async{
                              ...
                              var rsp = await aps.resetOgrPassword(email);
                              if(rsp['email'] == email){
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>OgrMailDogrulamaSayfasi()));
                                Alert(
                                  context: context,
