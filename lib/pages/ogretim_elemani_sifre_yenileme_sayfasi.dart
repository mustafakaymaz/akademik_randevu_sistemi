...
class OgretimElemaniSifreYenilemeFormu extends StatefulWidget {
  @override
  _OgretimElemaniSifreYenilemeFormuState createState() => _OgretimElemaniSifreYenilemeFormuState();
}

class _OgretimElemaniSifreYenilemeFormuState extends State<OgretimElemaniSifreYenilemeFormu> {
                        ...
                        child: MaterialButton(
                            ...
                            onPressed: () async {
                              ...
                              if(newPass == newPassCon){
                                var sifre = newPass;
                                await aps.newOgrPassword(sifre);
                                Alert(
                                  context: context,
